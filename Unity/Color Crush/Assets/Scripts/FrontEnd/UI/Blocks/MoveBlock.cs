...
public class MoveBlock : MonoBehaviour
{
	...
	private float firstBounce = 30f;

	private float secondBounce = 100f;

	private float thirdBounce = 300f;
	...
	public void BeginLerp(Vector3 begin, Vector3 end, float speed, float delay, float numberOfSteps)
	{
		...
		_midScale = new Vector3(transform.localScale.x - (numberOfSteps / firstBounce), transform.localScale.y + (numberOfSteps / firstBounce), transform.localScale.z);
		_midScale2 = new Vector3(transform.localScale.x - (numberOfSteps / secondBounce), transform.localScale.y + (numberOfSteps / secondBounce), transform.localScale.z);
		_midScale3 = new Vector3(transform.localScale.x - (numberOfSteps / thirdBounce), transform.localScale.y + (numberOfSteps / thirdBounce), transform.localScale.z);
